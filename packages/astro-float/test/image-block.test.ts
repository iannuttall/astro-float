...
describe("image blocks", () => {
  ...
  it("never takes away a wrapper the site wrote, only Float's declarations on it", () => {
    ...
    const marked = containerFrom('<div style="width:25%" data-float-island="" data-float-image="" contenteditable="false" draggable="true"><p><img src="a.png" alt="a"></p></div>');
