...
/**
 * One icon set for everything Float draws — sidebar, selection bubble, region
 * control, island bar. Lucide (ISC) paths on a 24px grid, 1.75 stroke, round
