...
export class DatePicker {
  ...
  private constructor(private opts: DatePickerOptions) {
    ...
    this.el.className = "lee-datepicker";
    ...
    this.grid.className = "lee-dp-grid";
    this.grid.setAttribute("role", "grid");

    const foot = document.createElement("div");
    foot.className = "lee-dp-foot";
    ...
    opts.anchor.setAttribute("data-lee-open", "");
  ...
  close() {
    ...
    this.opts.anchor.removeAttribute("data-lee-open");
