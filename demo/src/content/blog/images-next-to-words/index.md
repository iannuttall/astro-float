...
When you drop an image onto this article, Lee copies the file into this folder, shows it right here in the prose, and writes a plain relative Markdown link when you save:
